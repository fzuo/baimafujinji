...
<span style="color:orange">1. 给定一个有序（非降序）数组 nums，可含有重复元素，求最小的下标 i 使得nums[i]等于target，不存在则返回-1。</span>
...
<span style="color:orange">2. 给定一个有序（非降序）数组nums，可含有重复元素，求最大的下标 i 使得nums[i]等于target，不存在则返回-1。</span>
...
<span style="color:orange">3. 给定一个有序（非降序）数组nums，可含有重复元素，求target在数组中出现的次数。</span>
...
<span style="color:orange">4. 给定一个有序（非降序）数组nums，可含有重复元素，求最小的下标i使得nums\[i\]大于target，不存在则返回-1。</span>
...
<span style="color:orange">5. 给定一个有序（非降序）数组nums，可含有重复元素，求最大的下标i使得nums\[i\]小于target，不存在则返回-1。</span>
