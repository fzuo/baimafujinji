...
现在假设当前这一代中GG、Gg、gg分布的几率向量为W0=(p, q, r)T。那么就可以写出转移矩阵为：M0=pA+qB+rC。此处一个可能令人困惑的地方在于，转移矩阵跟当前这一代中的基因分布有关。如果下一代中的W1=(p', q', r')T发生变化，那么似乎转移矩阵也会不一样。这样就无法满足马尔科夫过程的假设。但事实上可以证明：M0=M1=M2=... ...
...
也就得到M0=M1=M2=... ...，所以这确实是一个马尔科夫链问题。如果W0表示这一代的基因分布，MW0表示下一代的基因分布，M2W0表示再一代的基因分布，则有M(MW0) = MW0。In conclusion, the games reach equilibrium after the first generation. 这也就是Hardy-Weinberg Law的主要结论。
